...
browserStartPromise
    .then(function (browserObj) {
        ...
        let emailWillBeEnteredPromise = page.type("input[id='input-1']", emailpassObj.email, { delay: 100 });
        return emailWillBeEnteredPromise;
    }).then(function () {
        let passwordWillBeEnteredPromise = page.type("input[type='password']", emailpassObj.password, { delay: 300 });
        return passwordWillBeEnteredPromise;
    }).then(function () {
        let loginWillBeDOnepromise = page.click('button[data-analytics="LoginPassword"]', { delay: 200 });
...
function waitAndClick(selector, cPage) {
    return new Promise(function (resolve, reject) {
        ...
        waitForModalPromise.then(function () {
                let clickModal =
                    cPage.click(selector, { delay: 1000 });
                return clickModal;
            }).then(function () {
                resolve();
            }).catch(function (err) {
